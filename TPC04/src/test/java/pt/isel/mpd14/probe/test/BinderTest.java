...
public class BinderTest extends TestCase{
    ...
    public void test_bind_to_student_properties_and_fields() throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, ParseException, NoSuchMethodException{
        /*
        Arrange
        */
        Map<String, Object> v = new HashMap<>();
        ...
        Act
        */
        Student s = Binder.bindToFieldsAndProperties(Student.class, v);
        /*
        Assert
        */
        Assert.assertEquals(v.get("name"), s.getName());
